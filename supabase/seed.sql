...
('LaunchPad', 'LaunchPad', 'from €690', 'Best for smaller businesses that need a credible online presence and a clean starting structure.', 'Potrivit pentru afaceri mai mici care au nevoie de o prezență online credibilă și un punct de plecare clar.', '["Responsive website", "Up to 5 main pages", "Service and contact editing", "Contact or inquiry form", "Basic SEO and launch setup"]'::jsonb, '["Website responsive", "Până la 5 pagini principale", "Editare servicii și informații de contact", "Formular de contact sau solicitări", "Setare SEO de bază și suport la lansare"]'::jsonb, false, 'Request a Quote', 'Solicită o ofertă', '/contact', 1),
('FlowSite', 'FlowSite', 'from €1,390', 'Best for businesses that need a stronger website plus booking or inquiry flow.', 'Potrivit pentru afaceri care au nevoie de un website mai puternic, plus flux de programare sau solicitări.', '["Everything in LaunchPad", "Booking or inquiry flow", "Stronger admin control", "Service, pricing, and inquiry management", "Conversion-focused page structure"]'::jsonb, '["Tot ce este inclus în LaunchPad", "Flux de programare sau solicitări", "Control administrativ mai bun", "Gestionare servicii, prețuri și solicitări", "Structură de pagină orientată spre conversie"]'::jsonb, true, 'Request a Quote', 'Solicită o ofertă', '/contact', 2),
('OpsCore', 'OpsCore', 'from €2,490', 'Best for businesses that need website, admin visibility, and operational support in one system.', 'Potrivit pentru afaceri care au nevoie de website, vizibilitate administrativă și suport operațional într-un singur sistem.', '["Everything in FlowSite", "Advanced admin dashboard", "Client record visibility", "Operational support workflows", "Reporting-ready structure"]'::jsonb, '["Tot ce este inclus în FlowSite", "Dashboard administrativ avansat", "Vizibilitate asupra evidenței clienților", "Fluxuri de suport operațional", "Structură pregătită pentru raportare"]'::jsonb, false, 'Book a Consultation', 'Programează o consultanță', '/contact', 3);
