...
export function HomeFinalCta({
  ...
  return (
    <Section className="pt-6 md:pt-8 lg:pt-10">
      <Container>
        <MotionReveal>
          <div className="relative overflow-hidden rounded-[2.5rem] border border-slate-900/85 bg-[linear-gradient(135deg,rgba(16,20,31,1)_0%,rgba(24,29,44,1)_42%,rgba(45,39,87,1)_100%)] px-7 py-10 text-white shadow-[0_38px_94px_-52px_rgba(12,16,28,0.72)] sm:px-10 sm:py-12 lg:px-12 lg:py-14">
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(93,69,209,0.22),transparent_32%),radial-gradient(circle_at_bottom_right,rgba(63,103,220,0.14),transparent_26%)]" />
            <div className="pointer-events-none absolute -left-16 top-1/2 h-56 w-56 -translate-y-1/2 rounded-full border border-white/8" />
            <div className="pointer-events-none absolute -right-8 bottom-10 h-40 w-40 rounded-full border border-white/8" />
            ...
            <div className="relative z-10 grid gap-10 lg:grid-cols-[minmax(0,1.02fr)_minmax(0,0.98fr)] lg:items-center">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-[1.8rem] border border-white/10 bg-white/8 p-6 backdrop-blur-md sm:col-span-2">
                ...
                {microPoints.map((point) => (
                  <div
                    key={point}
                    className="rounded-[1.5rem] border border-white/10 bg-white/6 px-5 py-4 text-sm font-medium text-white/78 backdrop-blur-sm"
                  >
